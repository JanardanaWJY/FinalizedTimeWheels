      ...
      <div class="m-auto">
        ...
        <div class="w-96 py-5 px-10 m-5 shadow-2xl">
          ...
          <form method="POST" action="<?php echo e(url('signupaction')); ?>">
            ...
            <div class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
              <div class="w-fit m-auto scale-50">
                <img src="<?php echo e(asset('images/Email Icon.png')); ?>">
              </div>
              <div class="col-span-9">
            ...
            <div class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
              <div class="w-fit m-auto scale-50">
                <img src="<?php echo e(asset('images/Password Icon Hollow.png')); ?>">
              </div>
              <div class="col-span-9">
...
<?php /**PATH C:\laravel\Time Wheels\time-wheels\resources\views/signup.blade.php ENDPATH**/ ?>