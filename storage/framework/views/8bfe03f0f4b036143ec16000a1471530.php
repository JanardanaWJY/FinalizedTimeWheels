                    ...
                    <div
                        ...
                        <div class="col-span-9">
                            <input name="username" type="text" placeholder="Username"
                                class="bg-transparent h-full w-full" value="<?php echo e(Session::get('username')); ?>">
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="col-span-9">
                            <input name="password" type="password" placeholder="Password"
                                class="bg-transparent h-full w-full" value="<?php echo e(Session::get('password')); ?>">
                        </div>
                    </div>
...
<?php /**PATH C:\laravel\TimeWheels\resources\views/signin.blade.php ENDPATH**/ ?>