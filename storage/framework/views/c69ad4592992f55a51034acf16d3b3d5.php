...
<body class="h-screen bg-offwhite">
    <div class="flex h-screen bg-cover" style="background-image: url('/Assets/Circle Motif.png');">
        <div class="m-auto">
            <img src="<?php echo e(asset('Assets/TimeWheelsLogo.png')); ?>" class="m-auto">
            <div class="w-96 py-5 px-10 m-5 shadow-2xl">
                ...
                <form method="POST" action="<?php echo e(url('signupaction')); ?>">
                    <?php echo csrf_field(); ?>
                    <div
                        ...
                        <div class="w-fit m-auto scale-50">
                            <img src="<?php echo e(asset('Assets/Username Icon.png')); ?>">
                        </div>
                    ...
                    <div
                        class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
                        <div class="w-fit m-auto scale-50">
                            <img src="<?php echo e(asset('Assets/Email Icon.png')); ?>">
                        </div>
                        <div class="col-span-9">
                    ...
                    <div
                        class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
                        <div class="w-fit m-auto scale-50">
                            <img src="<?php echo e(asset('Assets/Password Icon.png')); ?>">
                        </div>
                        <div class="col-span-9">
                    ...
                    <div
                        class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
                        <div class="w-fit m-auto scale-50">
                            <img src="<?php echo e(asset('Assets/Password Icon Hollow.png')); ?>">
                        </div>
                        <div class="col-span-9">
                    ...
                    <div class="grid grid-cols-10">
                        ...
                        <div class="w-fit col-span-9 text-sm">
                            <label class="font-nunito">I agree with all statements in the <u>Terms of
                                    Service</u></label>
                        </div>
                    </div>
            ...
            <div
                ...
                <a href="<?php echo e(url('signin')); ?>">I'm already a member</a>
            </div>
        </div>
    </div>
</body>
...
<?php /**PATH C:\laravel\TimeWheels\resources\views/signup.blade.php ENDPATH**/ ?>