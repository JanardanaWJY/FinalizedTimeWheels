          ...
          <form method="POST" action="/signinaction">
            ...
            <div class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
              ...
              <div class="col-span-9">
                <input name="username" type="text" placeholder="Username" class="bg-transparent h-full w-full" value="{{ Session::get('username') }}">
              </div>
            </div>
            ...
            <div class="border-b-2 border-black border-opacity-50 grid grid-cols-10 focus-within:border-opacity-100">
              ...
              <div class="col-span-9">
                <input name="password" type="password" placeholder="Password" class="bg-transparent h-full w-full" value="{{ Session::get('password') }}">
              </div>
            </div>
